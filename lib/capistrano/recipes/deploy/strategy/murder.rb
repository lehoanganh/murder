...
# @author lha
# capistrano will use this strategy if set :deploy_via, :murder
# otherwise manually execute taks in lib/murder/murder.rb and lib/murder/admin.rb
